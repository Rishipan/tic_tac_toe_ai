...
class FiniteScreen extends StatefulWidget {
  const FiniteScreen({super.key});

  @override
  State<FiniteScreen> createState() => _FiniteScreenState();
}

class _FiniteScreenState extends State<FiniteScreen> {
  bool exTurn = true;
